...
import serbiaUniversitiesData from "@/data/serbia-universities.json";
...
export default function Universities() {
  ...
  // Sync country from navbar context to API filter
  useEffect(() => {
    if (selectedCountry) {
      setApiCountry(selectedCountry);
    }
  }, [selectedCountry]);
...
// API Pagination filters (NEW - for backend integration)
  ...
  const [apiCountry, setApiCountry] = useState(selectedCountry || "");
...
useEffect(() => {
 ...
 const loadData = async () => {
  try {
    ...
    // Use hardcoded JSON data for Serbia instead of API call
    if (apiCountry === "RS") {
      const raw = serbiaUniversitiesData;
      console.log("[Universities] Using hardcoded Serbia data");
      ...
      console.log("[Universities] Serbia Parsed:", universitiesArray.length, "universities, total:", total);
      setTotalCount(total);
