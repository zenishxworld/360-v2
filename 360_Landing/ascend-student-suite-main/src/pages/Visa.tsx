  ...
  IT: [
    {
      ...
      description: "Receive official admission letter from Italian university",
      status: "completed",
    ...
    },
    {
      id: 2,
      title: "Health Insurance",
      description: "Obtain health insurance coverage valid in Italy",
      status: "current",
      documents: ["Insurance Certificate"],
      timeline: "In Progress",
    },
    ...
    {
      id: 4,
      title: "Permit to Stay",
      description: "Apply for Permesso di Soggiorno within 8 days of arrival",
      status: "pending",
      documents: [],
  ...
  RS: [
    {
      id: 1,
      title: "University Admission",
      description: "Receive official admission letter from Serbian university",
      status: "completed",
      documents: ["Admission Letter"],
      timeline: "Completed",
    },
    {
      id: 2,
      title: "Health Insurance",
      description: "Obtain health insurance coverage valid in Serbia",
      status: "current",
      documents: ["Insurance Certificate"],
      timeline: "In Progress",
    },
    {
      id: 3,
      title: "Visa Application",
      description: "Submit student visa application at Serbian embassy",
      status: "pending",
      documents: ["Visa Form", "Passport", "Photos"],
      timeline: "Pending",
    },
    {
      ...
      description: "Apply for temporary residence permit upon arrival",
      status: "pending",
      documents: [],
      timeline: "After Arrival",
    },
  ...
  IT: [
    ...
    },
    {
      ...
      items: [
        ...
        "Dichiarazione di Valore (Declaration of Value) for foreign degrees",
      ],
    },
    {
      category: "Financial",
      items: [
        "Bank statements (last 3–6 months)",
        "Proof of sufficient funds (approx. €6,000/year)",
        "Scholarship letter (if applicable)",
        "Sponsor financial proof + affidavit (if sponsor-funded)",
      ],
    },
    {
      category: "Health Insurance",
      items: [
        ...
        "Travel insurance for entry period",
      ],
    },
    {
      category: "Application Forms",
      items: [
        ...
        "Cover letter explaining study plan",
      ],
    },
    {
      category: "Accommodation",
      items: [
        "Proof of accommodation in Italy (rental agreement or dorm confirmation)",
      ],
    },
  ],
  RS: [
    ...
    },
    {
      ...
      items: [
        "Bank statements (last 3–6 months)",
        "Proof of sufficient funds (approx. €3,000/year)",
        "Scholarship letter (if applicable)",
        "Sponsor financial proof + affidavit (if sponsor-funded)",
      ],
    },
    {
      category: "Health Insurance",
      items: [
        "Health insurance coverage valid in Serbia",
        "Travel insurance for entry period",
      ],
    },
    {
    ...
    },
    {
      category: "Accommodation",
      items: [
        "Proof of accommodation in Serbia (rental agreement or dorm confirmation)",
      ],
    },
  ],
};
