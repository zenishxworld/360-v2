...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const [selectedCountry, setSelectedCountryState] = useState<"DE" | "UK" | "IT" | "RS">(
    "DE"
  );
  ...
  useEffect(() => {
    if (
      ...
      if (targetCountry === "Germany") {
        ...
        setIsCountryToggleDisabled(true);
      } else if (targetCountry === "Italy") {
        setSelectedCountryState("IT");
        setIsCountryToggleDisabled(true);
      } else if (targetCountry === "Serbia") {
        setSelectedCountryState("RS");
        setIsCountryToggleDisabled(true);
      }
    } else {
