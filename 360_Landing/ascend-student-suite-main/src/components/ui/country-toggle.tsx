...
const ItalyFlag = "https://flagcdn.com/w40/it.png";
const SerbiaFlag = "https://flagcdn.com/w40/rs.png";
    ...
    <div
      ...
      title={
        disabled
          ...
          : "Switch between Germany, UK, Italy, and Serbia"
      }>
      <button
      ...
      <button
        ...
        className={cn(
          ...
          value === "IT"
            ...
            : "text-[#2C3539] hover:text-[#E08D3C]",
          disabled && "cursor-not-allowed",
          disabled && value !== "IT" && "opacity-30"
        )}
        title={disabled ? "Locked" : "Italy"}>
        <img
          src={ItalyFlag}
          alt="Italy Flag"
          className="w-6 h-4 object-cover rounded-sm flex-shrink-0"
        />
        <span className="hidden sm:inline">Italy</span>
      </button>
      <button
        onClick={() => !disabled && onChange("RS")}
        disabled={disabled}
        className={cn(
          "flex items-center gap-2 rounded-pill transition-all duration-micro ease-out text-sm font-medium",
          "px-4 py-2",
          ...
          value === "RS"
            ...
            : "text-[#2C3539] hover:text-[#E08D3C]",
          disabled && "cursor-not-allowed",
          disabled && value !== "RS" && "opacity-30"
        )}
        title={disabled ? "Locked" : "Serbia"}>
        <img
          src={SerbiaFlag}
          alt="Serbia Flag"
          className="w-6 h-4 object-cover rounded-sm flex-shrink-0"
        />
        <span className="hidden sm:inline">Serbia</span>
      </button>
    </div>
  );
}
