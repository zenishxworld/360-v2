...
export const Navigation = ({
  ...
  const countries = [
    { code: "germany", name: "Germany", flag: "/germany-logo.png", path: null },
    { code: "uk", name: "United Kingdom", flag: "/uk-logo.png", path: null },
    { code: "italy", name: "Italy", flag: "https://flagcdn.com/w40/it.png", path: "/study-in-italy" },
    { code: "serbia", name: "Serbia", flag: "https://flagcdn.com/w40/rs.png", path: "/study-in-serbia" },
  ];
  ...
  const handleCountryClick = (country: typeof countries[0]) => {
    if (country.path) {
      // Navigate to country-specific page (Italy/Serbia)
      navigate(country.path);
    } else {
      // Navigate to home and toggle selection (Germany/UK)
      navigate("/");
                    ...
                    <DropdownMenuContent className="w-48 bg-background border border-border shadow-lg z-50">
                      {countries.map((country) => (
                        <DropdownMenuItem
                          ...
                          {!country.path && selectedCountries.includes(country.code) && (
