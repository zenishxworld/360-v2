...
import { Serbia } from "@/components/Serbia";
...
export const LandingPage = () => {
  const [selectedCountries, setSelectedCountries] = useState<string[]>(["germany", "uk", "italy", "serbia"]);
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <div className="w-full max-w-full overflow-hidden">
        ...
        <div className="w-full max-w-full">
          <Italy selectedCountries={selectedCountries} />
        </div>

        <div className="w-full max-w-full">
          <Serbia selectedCountries={selectedCountries} />
        </div>
