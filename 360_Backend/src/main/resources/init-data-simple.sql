...
INSERT INTO universities (
    ...
    'Sapienza University of Rome', 'SUR', true,
    '{
        "official_name": "Sapienza – Universita di Roma",
        "short_name": "Sapienza",
        "former_names": ["Universita degli Studi di Roma"],
        "country": "Italy",
        "country_code": "IT",
        "state": "Lazio",
        "city": "Rome",
        ...
        "phone": "+39-06-49911",
        "admissions_email": "admissions@uniroma1.it",
        "admissions_phone": "+39-06-49911",
        "institution_type": "PUBLIC",
        "type": "COMPREHENSIVE",
        "founding_year": 1303,
        "total_students": 112000,
        "undergraduate_students": 85000,
        "graduate_students": 27000,
        "faculty_count": 4000,
        "world_ranking": 134,
        "national_ranking": 1,
        "qs_ranking": 171,
        "tuition_international_undergraduate": 1000.00,
        "tuition_international_graduate": 1500.00,
        "application_fee": 30.00,
        "currency": "EUR",
        "scholarships_available": true,
        "acceptance_rate": 0.25,
        "application_deadline_fall": "2024-06-30",
        "commission_rate": 10.0,
        "english_requirements": {
            "TOEFL_min": 80,
            "IELTS_min": 6.0
        },
        "affiliations": ["EUA", "UNICA", "CIVIS", "SGroup"],
        "languages_of_instruction": ["Italian", "English"],
        "research_facilities": ["Particle Physics Lab", "Archaeology Institute", "Medical Research Center", "Aerospace Engineering Lab"],
        "sports_facilities": ["University Sports Center", "Olympic Swimming Pool", "Fitness Center", "Athletic Track", "Tennis Courts"],
        "student_services": ["International Student Office", "Career Center", "Psychological Counseling", "Disability Services"],
        "schools_colleges": ["Faculty of Medicine", "Faculty of Engineering", "Faculty of Humanities", "Faculty of Law", "Faculty of Architecture"],
        "degree_levels": ["Bachelor", "Master", "Doctorate"],
        "popular_majors": ["Medicine", "Architecture", "Engineering", "Law", "Physics"],
        "description": "One of Europe''s largest universities, founded in 1303, located in the heart of Rome. Ranked #1 in Italy for research and teaching excellence.",
        "verification_status": "VERIFIED",
        "status": "ACTIVE",
        "is_featured": true,
        "client_id": "uniflow"
...
INSERT INTO universities (
    ...
    'University of Bologna', 'UNIBO', true,
    '{
        "official_name": "Alma Mater Studiorum – Universita di Bologna",
        "short_name": "UNIBO",
        "country": "Italy",
        "country_code": "IT",
        ...
        "admissions_email": "admissions@unibo.it",
        "admissions_phone": "+39-051-2099111",
        "institution_type": "PUBLIC",
        "type": "COMPREHENSIVE",
        "founding_year": 1088,
        "total_students": 85000,
        "undergraduate_students": 65000,
        "graduate_students": 20000,
        "faculty_count": 3000,
        "world_ranking": 160,
        "national_ranking": 2,
        "qs_ranking": 167,
        ...
        "affiliations": ["Coimbra Group", "EUA", "UNIMED", "Utrecht Network", "Una Europa"],
        "languages_of_instruction": ["Italian", "English"],
        "research_facilities": ["Institute of Advanced Studies", "Interdepartmental Research Centers", "Data Science Lab"],
        "sports_facilities": ["CUSB Sports Center", "Fitness Center", "Swimming Pool", "Soccer Fields"],
        "student_services": ["International Desk", "Student Career Service", "Counseling Center", "Student Associations"],
        "schools_colleges": ["School of Law", "School of Medicine", "School of Engineering", "School of Economics", "School of Arts"],
        "degree_levels": ["Bachelor", "Master", "Doctorate"],
        "popular_majors": ["Law", "Economics", "Engineering", "Medicine", "International Relations"],
        "description": "The oldest university in the Western world, founded in 1088. A leading comprehensive university with strong international reputation.",
        "verification_status": "VERIFIED",
        "status": "ACTIVE",
        "is_featured": true,
        "client_id": "uniflow"
...
INSERT INTO universities (
    ...
    'Politecnico di Milano', 'POLIMI', true,
    '{
        "official_name": "Politecnico di Milano",
        "short_name": "PoliMi",
        "country": "Italy",
        "country_code": "IT",
        "state": "Lombardy",
        ...
        "phone": "+39-02-23991",
        "admissions_email": "admissions@polimi.it",
        "admissions_phone": "+39-02-23992104",
        "institution_type": "PUBLIC",
        "type": "TECHNICAL",
        "founding_year": 1863,
        "total_students": 47000,
        "undergraduate_students": 28000,
        "graduate_students": 19000,
        "faculty_count": 1400,
        "world_ranking": 139,
        "national_ranking": 3,
        "qs_ranking": 123,
        "tuition_international_undergraduate": 3900.00,
        "tuition_international_graduate": 3900.00,
        "application_fee": 50.00,
        "currency": "EUR",
        "scholarships_available": true,
        ...
        "affiliations": ["IDEA League", "CESAER", "PEGASUS", "TIME", "Erasmus+"],
        "languages_of_instruction": ["Italian", "English"],
        "research_facilities": ["Advanced Robotics Lab", "Nanotechnology Center", "Energy Research Center", "Design Lab"],
        "sports_facilities": ["PoliMi Sport Center", "Fitness Center", "Soccer Fields", "Volleyball Courts"],
        "student_services": ["Welcome Desk", "Career Service", "Counseling Service", "Buddy Program"],
        "schools_colleges": ["School of Architecture", "School of Design", "School of Engineering"],
        "degree_levels": ["Bachelor", "Master", "Doctorate"],
        "popular_majors": ["Architecture", "Design", "Mechanical Engineering", "Computer Science", "Aerospace Engineering"],
        "description": "Italy''s top technical university and one of Europe''s best, renowned for engineering, architecture, and design. Consistently ranked in the global top 150.",
        "verification_status": "VERIFIED",
        "status": "ACTIVE",
        "is_featured": true,
        "client_id": "uniflow"
...
INSERT INTO courses (
    ...
    (SELECT id FROM universities WHERE code = 'SUR' LIMIT 1),
    'Bachelor of Science in Computer Engineering', 'SUR-BSc-CE', true,
    '{
        "official_name": "Laurea in Ingegneria Informatica",
        "degree_level": "BACHELORS",
        "degree_type": "Bachelor of Science",
        "field_of_study": "Computer Engineering",
        "subject_area": "Engineering",
        "academic_department": "Faculty of Information Engineering, Informatics and Statistics",
        "duration_years": 3.0,
        "study_mode": "FULL_TIME",
        "tuition_international": 1200.00,
        "currency": "EUR",
        "admission_requirements": {
            "high_school_diploma": true,
            "mathematics_entrance": true,
...
INSERT INTO courses (
    ...
    (SELECT id FROM universities WHERE code = 'SUR' LIMIT 1),
    'Master of Science in Data Science', 'SUR-MSc-DS', true,
    '{
        "official_name": "Laurea Magistrale in Data Science",
        "degree_level": "MASTERS",
        "degree_type": "Master of Science",
        ...
        "duration_years": 2.0,
        "study_mode": "FULL_TIME",
        "tuition_international": 1800.00,
        "currency": "EUR",
        "admission_requirements": {
            "bachelor_required": true,
            "min_gpa": 3.0,
            "statistics_background": true
        }
    }'::jsonb,
    'system', 'system'
) ON CONFLICT (course_code, university_id) DO NOTHING;
...
INSERT INTO courses (
    ...
    (SELECT id FROM universities WHERE code = 'SUR' LIMIT 1),
    'Master of Science in Architecture', 'SUR-MSc-ARCH', true,
    '{
        "official_name": "Laurea Magistrale in Architettura",
        "degree_level": "MASTERS",
        "degree_type": "Master of Science",
        "field_of_study": "Architecture",
        "subject_area": "Architecture and Design",
        "academic_department": "Faculty of Architecture",
        "duration_years": 2.0,
        "study_mode": "FULL_TIME",
        "tuition_international": 1800.00,
        "currency": "EUR",
        "admission_requirements": {
            "bachelor_architecture": true,
...
INSERT INTO courses (
    ...
    (SELECT id FROM universities WHERE code = 'SUR' LIMIT 1),
    'Bachelor of Arts in International Relations', 'SUR-BA-IR', true,
    '{
        "official_name": "Laurea in Relazioni Internazionali",
        "degree_level": "BACHELORS",
        "degree_type": "Bachelor of Arts",
        "field_of_study": "International Relations",
        "subject_area": "Social Sciences",
        "academic_department": "Faculty of Political Science",
        "duration_years": 3.0,
        "study_mode": "FULL_TIME",
        "tuition_international": 1000.00,
        "currency": "EUR",
        "admission_requirements": {
            "high_school_diploma": true,
            "english_proficiency": "B2"
...
INSERT INTO courses (
    ...
    (SELECT id FROM universities WHERE code = 'UNIBO' LIMIT 1),
    'Bachelor of Science in Economics and Finance', 'UNIBO-BSc-EF', true,
    '{
        "official_name": "Laurea in Economia e Finanza",
        "degree_level": "BACHELORS",
        "degree_type": "Bachelor of Science",
        "field_of_study": "Economics and Finance",
        "subject_area": "Social Sciences",
        "academic_department": "Department of Economics",
        "duration_years": 3.0,
        "study_mode": "FULL_TIME",
        "tuition_international": 1200.00,
        "currency": "EUR",
...
INSERT INTO courses (
    ...
    (SELECT id FROM universities WHERE code = 'UNIBO' LIMIT 1),
    'Master of Laws in International Law', 'UNIBO-LLM', true,
    '{
        "official_name": "Laurea Magistrale in Giurisprudenza Internazionale",
        "degree_level": "MASTERS",
        "degree_type": "Master of Laws",
        "field_of_study": "International Law",
        "subject_area": "Law",
        "academic_department": "Department of Legal Studies",
        "duration_years": 2.0,
        "study_mode": "FULL_TIME",
        "tuition_international": 1800.00,
        "currency": "EUR",
...
INSERT INTO courses (
    ...
    (SELECT id FROM universities WHERE code = 'UNIBO' LIMIT 1),
    'Master of Science in Biomedical Engineering', 'UNIBO-MSc-BME', true,
    '{
        "official_name": "Laurea Magistrale in Ingegneria Biomedica",
        "degree_level": "MASTERS",
        "degree_type": "Master of Science",
        "field_of_study": "Biomedical Engineering",
        "subject_area": "Engineering",
        "academic_department": "Department of Engineering",
        "duration_years": 2.0,
        "study_mode": "FULL_TIME",
        "tuition_international": 1800.00,
        "currency": "EUR",
...
INSERT INTO courses (
    ...
    (SELECT id FROM universities WHERE code = 'POLIMI' LIMIT 1),
    'Bachelor of Science in Aerospace Engineering', 'POLIMI-BSc-AE', true,
    '{
        "official_name": "Laurea in Ingegneria Aerospaziale",
        "degree_level": "BACHELORS",
        "degree_type": "Bachelor of Science",
        "field_of_study": "Aerospace Engineering",
        "subject_area": "Engineering",
        "academic_department": "Department of Aerospace Science and Technology",
        "duration_years": 3.0,
        "study_mode": "FULL_TIME",
        "tuition_international": 3900.00,
        "currency": "EUR",
        "admission_requirements": {
            "high_school_diploma": true,
            "mathematics_entrance": true,
            "physics_entrance": true
        }
    }'::jsonb,
    'system', 'system'
) ON CONFLICT (course_code, university_id) DO NOTHING;
...
INSERT INTO courses (
    ...
    (SELECT id FROM universities WHERE code = 'POLIMI' LIMIT 1),
    'Master of Science in Product Design', 'POLIMI-MSc-PD', true,
    '{
        "official_name": "Laurea Magistrale in Design del Prodotto",
        "degree_level": "MASTERS",
        "degree_type": "Master of Science",
        "field_of_study": "Product Design",
        "subject_area": "Design",
        "academic_department": "School of Design",
        "duration_years": 2.0,
        "study_mode": "FULL_TIME",
        "tuition_international": 3900.00,
        "currency": "EUR",
        "admission_requirements": {
            "bachelor_design": true,
            "portfolio_required": true,
            "english_proficiency": "B2"
        }
    }'::jsonb,
...
INSERT INTO courses (
    ...
    (SELECT id FROM universities WHERE code = 'POLIMI' LIMIT 1),
    'Master of Science in Robotics and Automation', 'POLIMI-MSc-RA', true,
    '{
        "official_name": "Laurea Magistrale in Robotica e Automazione",
        "degree_level": "MASTERS",
        "degree_type": "Master of Science",
        "field_of_study": "Robotics and Automation",
        "subject_area": "Engineering",
        "academic_department": "Department of Electronics, Information and Bioengineering",
        "duration_years": 2.0,
        "study_mode": "FULL_TIME",
        "tuition_international": 3900.00,
        "currency": "EUR",
        "admission_requirements": {
            ...
            "control_systems_background": true
        }
    }'::jsonb,
    'system', 'system'
) ON CONFLICT (course_code, university_id) DO NOTHING;
...
INSERT INTO courses (
    ...
    (SELECT id FROM universities WHERE code = 'POLIMI' LIMIT 1),
    'Bachelor of Science in Architectural Design', 'POLIMI-BSc-AD', true,
    '{
        "official_name": "Laurea in Progettazione dell Architettura",
        "degree_level": "BACHELORS",
        "degree_type": "Bachelor of Science",
        "field_of_study": "Architectural Design",
        "subject_area": "Architecture and Design",
        "academic_department": "School of Architecture Urban Planning Construction Engineering",
        "duration_years": 3.0,
        "study_mode": "FULL_TIME",
        "tuition_international": 3900.00,
        "currency": "EUR",
        "admission_requirements": {
            "high_school_diploma": true,
            "architecture_entrance_test": true,
            "english_proficiency": "B2"
        }
    }'::jsonb,
    'system', 'system'
