...
public class RouterConfig {
        ...
        private final com.uniflow.chat.handler.ChatHandler chatHandler;
        private final com.uniflow.lead.handler.LeadHandler leadHandler;
        private final com.uniflow.serbia.handler.SerbiaLeadHandler serbiaLeadHandler;
        private final com.uniflow.serbia.handler.AdminSerbiaLeadHandler adminSerbiaLeadHandler;
        ...
        /**
         * Serbia lead router - student-facing endpoints
         */
        private RouterFunction<ServerResponse> serbiaRouter() {
                return route()
                                .path("/serbia/leads", () -> route()
                                                .POST("", serbiaLeadHandler::submitLead)
                                                .GET("/my", serbiaLeadHandler::getMyLeads)
                                                .GET("/{id}", serbiaLeadHandler::getLeadById)
                                                .build())
                                .build();
        }
                ...
                return route()
                                .path("/admin", () -> route()
                                                ...
                                                .path("/ai", () -> route()
                                                                ...
                                                                .build())
                                                // Admin Serbia lead management
                                                .path("/serbia/leads", () -> route()
                                                                .GET("", adminSerbiaLeadHandler::getAllLeads)
                                                                .GET("/{id}", adminSerbiaLeadHandler::getLeadById)
                                                                .PUT("/{id}/status", adminSerbiaLeadHandler::updateLeadStatus)
                                                                .build())
                                                .build())
                                .build();
        }
        ...
        private RouterFunction<ServerResponse> publicRouter() {
                return route()
                                .path("/public", () -> route()
                                                ...
                                                .POST("/lead", leadHandler::submitLead)
                                                .build())
                                .build();
        }
